...
void Management::Sort()//排序，分两种方式
{
	...
	for (int i = 0;i < present;i++)
	{
		...
		{
			cout << "**客车**\n";
			cout << "编号" << setw(8) << "车牌" << setw(8) << "公司" << setw(12) << "日期" << setw(8) << "里程" << setw(8) << "耗油" << setw(8) << "载客量" << endl;
			cout << t[i].Number << setw(8) << t[i].carnum << setw(8) << t[i].cname << setw(12) << t[i].year << "-" << t[i].month << "-" << t[i].day << setw(8) << t[i].km << setw(8) << t[i].V << setw(5) << t[i].B << endl;
			cout << "***************************************************************************" << endl;
			Km1 = Km1 + t[i].km;
		}
		else continue;
	...
	for (int i = 0;i < present;i++)
	{
		...
		{
			cout << "轿车\n";
			cout << "编号" << setw(8) << "车牌" << setw(8) << "公司" << setw(8) << "日期" << setw(8) << "里程" << setw(8) << "耗油" << setw(8) << "厢数：" << endl;
			cout << t[i].Number << setw(8) << t[i].carnum << setw(8) << t[i].cname << setw(12) << t[i].year << "-" << t[i].month << "-" << t[i].day << setw(8) << t[i].km << setw(8) << t[i].V << setw(5) << t[i].C << endl;
			cout << "***************************************************************************" << endl;
			Km2 = Km2 + t[i].km;
		}
		else continue;
	...
	for (int i = 0;i < present;i++)
	{
		...
		{
			cout << "卡车\n";
			cout << "编号" << setw(8) << "车牌" << setw(8) << "公司" << setw(12) << "日期" << setw(8) << "里程" << setw(8) << "耗油" << setw(5) << "载重：" << endl;
			cout << t[i].Number << setw(8) << t[i].carnum << setw(8) << t[i].cname << setw(12) << t[i].year << "-" << t[i].month << "-" << t[i].day << setw(8) << t[i].km << setw(8) << t[i].V << setw(5) << t[i].T << endl;
			cout << "***************************************************************************" << endl;
			Km3 = Km3 + t[i].km;
		}
		else continue;
...
void Management::Showinfor()//显示信息
{
	...
	{
		cout << "****所有车辆的信息为：\n"
			<< "类型" << setw(5) << "编号" << setw(8) << "车牌" << setw(8) << "公司"  << setw(9) << "里程" << setw(8) << "耗油量" << setw(8) << "载客量" << setw(8) << "载重量" << setw(8) << "厢数" <<setw(8)<< "日期" << endl;
		for (int i = 0;i < present;i++)
		{
			cout << t[i].Type << setw(5) << t[i].Number << setw(8) << t[i].carnum << setw(8) << t[i].cname << setw(8) << t[i].km << setw(8) << t[i].V << setw(8) << t[i].B << setw(9) << t[i].T << setw(7) << t[i].C <<setw(9)<< t[i].year << "-" << t[i].month << "-" << t[i].day <<endl;
		}
	}
...
void Management::Menu()//菜单
{
	...
	case 11:cout << "******************【退出系统】*****************" << endl;cout << setw(10)<<"*感";Sleep(200);cout << "谢";Sleep(200);cout << "您";Sleep(200);cout << "的";Sleep(200);cout << "使";Sleep(200);cout << "用！*";Sleep(200);break;
...
void Management::write()//写操作
{
	...
	if (write)
	{
		for (int i = 0; i < present; i++)
		{
			...
			write << endl;
			write << t[i].Number << " " <<t[i].type<<" "<< t[i].carnum << " " << t[i].cname << " " << t[i].year << " " << t[i].month << " " << t[i].day << " " << t[i].km << " " << t[i].V << " " << t[i].ymoney;
			if (t[i].type == 1)
				write << t[i].B;
			else if (t[i].type == 2)
				write << t[i].C;
